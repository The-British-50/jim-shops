...
Config = {
	...
	Products = {
		["normal"] = {
			{ name = "tosti", price = 75, amount = 10, },
			{ name = "water_bottle", price = 75, amount = 10, },
			{ name = "kurkakola", price = 75, amount = 10, },
			{ name = "twerks_candy", price = 75, amount = 10, },
			{ name = "snikkel_candy", price = 75, amount = 10, },
			{ name = "sandwich", price = 75, amount = 10, },
			{ name = "beer", price = 75, amount = 10, },
			{ name = "whiskey", price = 75, amount = 10, },
			{ name = "vodka", price = 50000, amount = 10, },
			{ name = "bandage", price = 100, amount = 10, },
			{ name = "lighter", price = 75, amount = 10, },
			{ name = "rolling_paper", price = 75, amount = 100,  },
		},
		["bar"] = {
		...
		["hardware"] = { 
			...
			{ name = "weapon_wrench", price = 250, amount = 25, },
			{ name = "weapon_hammer", price = 250, amount = 25, },
			{ name = "weapon_bat", price = 500, amount = 10,  requiredGang = { "lostmc" } },  -- Gang only options in stores
			{ name = "repairkit", price = 750, amount = 10,  requiredJob = { ["mechanicjonno"] = 0, ["police"] = 0, ["tuner"] = 0, ["b50visuals"] = 0, ["yiannimize"] = 0, ["mechanicmarc"] = 0 } },
			{ name = "screwdriverset", price = 350, amount = 10, },
			{ name = "radio", price = 250, amount = 10, },
			{ name = "binoculars", price = 50, amount = 10, },
			{ name = "firework1", price = 50, amount = 10, },
			{ name = "firework2", price = 50, amount = 10, },
			{ name = "firework3", price = 50, amount = 10, },
			{ name = "firework4", price = 50, amount = 10, },
			{ name = "fitbit", price = 400, amount = 15, },
			{ name = "cleaningkit", price = 150, amount = 15, },
			{ name = "plasticjerrycan", price = 150, amount = 25, },
		...
		["weedshop"] = {
			...
			{ name = "empty_weed_bag", price = 2, amount = 500, },
		},
		["gearshop"] = {
		...
		["weapons"] = {
			...
			{ name = "weapon_pistol", price = 5000, amount = 10, },
			{ name = "pistol_ammo", price = 500, amount = 20, },
		},
		["coffeeplace"] = {
		...
		["electronics"] = {
			{ name = "phone", price = 850, amount = 10 },
			{ name = "powerbank", price = 50, amount = 10, },
			{ name = "radio", price = 250, amount = 10, },
			{ name = "screwdriverset", price = 350, amount = 10, },
			{ name = "binoculars", price = 50, amount = 10, },
			{ name = "fitbit", price = 400, amount = 15, },
			{ name = "pokemonalbum", price = 250, amount = 10, },

		},
		["vending"] = {
			{ name = "water_bottle", price = 100, amount = 10, },
			{ name = "kurkakola", price = 100, amount = 10, },
			{ name = "sprunk", price = 100, amount = 10, },
			{ name = "sprunklight", price = 100, amount = 10, },
			{ name = "ecola", price = 100, amount = 10, },
			{ name = "ecolalight", price = 100, amount = 10, },
			{ name = "twerks_candy", price = 100, amount = 10, },
			{ name = "snikkel_candy", price = 100, amount = 10, },
		},
		["blackmarket"] = {
		...
		["wholesale"] = {
			-- Burgershot
			{ name = 'burgerpatty', price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = 'potato', 		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = 'onion', 		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = 'frozennugget', price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = 'milk', 		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = 'icecream', 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = 'burgerbun', 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = 'cheddar', 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = 'lettuce', 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			-- Up n Atom
			{ name = "tomato", 		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = "hotdogbun", 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = "rawbacon", 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = "rawhotdog", 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = "chillimince",	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = "butter",		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "chickenbreast",price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			-- Hornys
			{ name = "egg", 		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = "breadslice", 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			{ name = "rawsausage", 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			-- Combined Up N Atom & Hornys
			{ name = "cream", 		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
			-- Billiards Bar
			{ name = "cherry", 		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "lime", 		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "lemon", 		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "pineapple", 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "coconut", 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "cranberry", 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "apple", 		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "orange", 		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "tomato", 		price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "steakpie", 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "chickenpie", 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "meatpie", 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
            { name = "cheesepie", 	price = 5, amount = 1000, requiredJob = { ["upnatom"] = 0, ["hornys"] = 0, ["burgershot"] = 0, ["billiards"] = 0 } },
...
Config.Locations = {
    ...
    ["hardware"] = {
		...
		["coords"] = {
			...
			vector4(2746.4, 3470.14, 55.67, 244.51),
